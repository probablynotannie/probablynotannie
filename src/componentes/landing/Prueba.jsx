    ...
    <ol class="relative border-s border-gray-200 dark:border-gray-700">
      <li class="mb-10 ms-6">
        ...
        <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
          Páginas B2B y B2C para agencias de viajes, enfocadas en una
          experiencia de usuario fluida y eficiente, utilizando componentes
          reutilizables e inputs diseñadas de cero. Asi mismo mplementado
          motores de búsqueda y sistemas de filtrado, así como integraciones con
          APIs externas.
        </p>
        <a
          href="#"
