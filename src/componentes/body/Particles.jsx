...
function Particulos() {
  return (
    <div className="">
      ...
      <div className="floating-orb-2 w-80 h-80 bg-gradient-to-r from-pink-400 to-pink-500 top-10 -right-48 opacity-20"></div>
      ...
      <div className="floating-orb-2 w-64 h-64 bg-gradient-to-r from-green-400 to-blue-400 bottom-20 left-1/2 opacity-20 animation-delay: -2s;"></div>
